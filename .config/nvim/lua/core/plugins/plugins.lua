...
return require('packer').startup(function(use)
  ...
  use 'nvimtools/none-ls.nvim' -- formatter
  use 'smoka7/multicursors.nvim' -- multiline cursor
  use 'HiPhish/rainbow-delimiters.nvim' -- delimiters
  use 'jreybert/vimagit' -- git
